import { ModelCoreUnion, TypeValidationError, RequiredError, ImmutablePropertyError, ImmutableObjectError, RangeError, EnumValueError, SchemaDefinitionError, isNone, buildError, normalizeConf, createProxyHandler, createArrayHandler, createSetHandler, createObjectHandler, createMapHandler } from "../index.js";
...
export default class Base {
    ...
    runValidate(confPassed, valuePassed, path, isNew) {
        ...
        const isMap = (!isArray && !isSet &&
            (conf.type === Map || (unionTypes && unionTypes.some((t) => t === Map || t.prototype instanceof Map))))
            && value instanceof Map;
        const isObject = (!isArray && !isSet &&
            (conf.type === Object || (unionTypes && unionTypes.some((t) => t === Object)))) &&
